            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
               ...
               <h4>Stranice</h4>
                ...
                <ul><!-- ul Begin -->
                    ...
                    <li><a href="my_account.php">Moj nalog</a></li>
                </ul><!-- ul Finish -->
                ...
                <ul><!-- ul Begin -->
                           ...
                           if(!isset($_SESSION['korisnik_email'])){
                              ...
                              echo"<a href='my_account.php?my_orders'>Moj nalog</a>"; 
                    ...
                    <li>
                           ...
                           if(!isset($_SESSION['korisnik_email'])){
                              ...
                              echo"<a href='my_account.php?edit_account'>Izmeni nalog</a>"; 
